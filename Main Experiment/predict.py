...
def main():
    ...
    parser.add_argument('--save_dir', default='./output/only_intermedia', help='path to save checkpoints and logs')
    # parser.add_argument('--model_name_or_path', default='./model/bart-kopl')
    parser.add_argument('--ckpt',  default='./output/only_intermedia/checkpoint/checkpoint-150325')
