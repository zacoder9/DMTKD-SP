...
def main():
    ...
    parser.add_argument('--output_dir', default='./output/plus_subset/checkpoint')

    parser.add_argument('--save_dir', default='./output/plus_subset/log_raw', help='path to save checkpoints and logs')
    parser.add_argument('--model_name_or_path', default='./output/plus_subset/checkpoint/checkpoint-30065')
