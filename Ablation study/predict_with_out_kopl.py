...
def main():
    ...
    parser.add_argument('--save_dir', default='./output/without_kopl_teacher/predict_result', help='path to save checkpoints and logs')
    # parser.add_argument('--model_name_or_path', default='./model/bart-kopl')
    parser.add_argument('--ckpt',  default='./output/without_kopl_teacher/checkpoint/checkpoint-36084')
