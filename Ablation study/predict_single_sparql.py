...
def main():
    ...
    parser.add_argument('--save_dir', default='./output/single_teacher_sparql/predict_result', help='path to save checkpoints and logs')
    # parser.add_argument('--model_name_or_path', default='./model/bart-kopl')
    parser.add_argument('--ckpt',  default='./output/single_teacher_sparql/checkpoint/checkpoint-69161')
