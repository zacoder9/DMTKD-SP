...
def main():
    ...
    parser.add_argument('--save_dir', default='./output/without_confidence/predict_result', help='path to save checkpoints and logs')
    # parser.add_argument('--model_name_or_path', default='./model/bart-kopl')
    parser.add_argument('--ckpt',  default='./output/without_confidence/checkpoint/checkpoint-18042')
