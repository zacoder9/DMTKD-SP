...
def train(args):
    ...
    for _ in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_loader):
            ...
            loss = loss_ce.mean() +  sparql_kd_weight * transfer_sparql_loss_ce.mean() + dcs_kd_weight * transfer_dcs_loss_ce.mean()
...
def main():
    ...
    parser.add_argument('--output_dir', default='./output/without_kopl_teacher/checkpoint')

    parser.add_argument('--save_dir', default='./output/without_kopl_teacher/log_raw', help='path to save checkpoints and logs')
