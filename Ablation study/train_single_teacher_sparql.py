...
def train(args):
    ...
    for _ in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_loader):
            ...
            # 只保留sparql做为单教师
            loss = loss_ce.mean()  + sparql_kd_weight * transfer_sparql_loss_ce.mean()
...
def main():
    ...
    parser.add_argument('--output_dir', default='./output/single_teacher_sparql/checkpoint')

    parser.add_argument('--save_dir', default='./output/single_teacher_sparql/log_raw', help='path to save checkpoints and logs')
    parser.add_argument('--model_name_or_path', default='./output/single_teacher_sparql/checkpoint/checkpoint-21049')
